...
export const BentoGridItem: React.FC<BentoGridItemProps> = ({
  ...
  return (
    <div
      className={cn(
        "row-span-1 rounded-xl group/bento hover:shadow-xl transition duration-200 p-4 dark:bg-slate-900 dark:border-white/[0.2] bg-slate-900 border border-transparent justify-between flex flex-col space-y-4",
        className,
      )}
    >
      {header}
